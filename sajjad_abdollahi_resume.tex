  ...
  \resumeSubHeadingListStart
	...
	{Laravel and Livewire are great pair for designing the architecture of the website that fully qualified for ajax behaviour and REST APIs }
      ...
      \resumeItemListStart
        ...
        \resumeProjectItem{ \textbf{MVC Architecture} and use models and controllers to handle the logics of the whole system} 
	...
	\vspace{-10pt}
	\resumeItemListStart
	\resumeProjectItem{ \textbf{ artisan : }  use php artisan utility command to migrate database tables}
        \resumeProjectItem{ \textbf{ Sanctum : }  Authentication and authorization standards such as Sanctum, OAuth}
        \resumeProjectItem{ \textbf{Tailwindcss} for design}
	\resumeProjectItem{ \textbf{composer} using composer to install third party packages}
      \resumeItemListEnd
	...
	\resumeItemListStart
        ...
        \resumeProjectItem{Theming web application for beautiful Colors}
...
% , with the help of php artisan commands it is very simple to make the necessary tables you need to design your databse , Blade is bay far the best view engine i have ever worked with and it is the great for simple application front-end , absolutely php laravel tools are awesome to build custom look web app and impress your clients
	...
	\resumeItemListStart
        ...
        \resumeProjectItem{ \textbf{Testing} and validating work produced as part of the development process}
...
\end{comment}
  ...
  \resumeSubHeadingListEnd
   ...
   \resumeSubHeadingListStart
    \resumeSubheading
      {Chatbox}{Sari, Iran}
      {Javascript Developer}{Feb 2019 - Apr 2020}
...
\section{Publications}
  \vspace{10pt}
  \begin{itemize}%[label=$\circ$]
    \item{ AVL Trees and Red-Black Trees  }
    \item{ Computer and Network handbook   }
